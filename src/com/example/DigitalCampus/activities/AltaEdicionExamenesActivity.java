...
public class AltaEdicionExamenesActivity extends BaseActivity implements OnItemSelectedListener{
...
//spiner aulas
		...
		actionBar.setSubtitle("Añadir examen");
		addListenerOnButton();
	...
	public void addListenerOnSpinnerItemSelection() {
	  ...
	  public void addListenerOnButton() {
		...
		btnSubmit.setOnClickListener(new View.OnClickListener() {
					...
					getMyApplication().databaseExamenes.insertarExamen(idAsig, idCarrera, idAula, editFecha.getText().toString(), editHora.getText().toString());
